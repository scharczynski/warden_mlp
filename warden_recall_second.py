...
def run_script(cell_range):
    ...
    save_dir = "/projectnb/ecog-eeg/stevechar/ml_runs/warden/recall_second/"
    path_to_data = "/projectnb/ecog-eeg/stevechar/data/warden/recall_second/"
    ...
    with open("/projectnb/ecog-eeg/stevechar/data/warden/recall_second/info.json") as f:
        stims = json.load(f)
