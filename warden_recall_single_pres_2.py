...
def run_script(cell_range):
    ...
    save_dir = "/projectnb/ecog-eeg/stevechar/ml_runs/warden/recall_trials_single_pres_2/"
    path_to_data = "/projectnb/ecog-eeg/stevechar/data/warden/recall_trials/"
    data_processor = analysis.DataProcessor(
        path_to_data, cell_range, window=[1500, 3000])
    solver_params = {
        "niter": 1500,
        "stepsize": 100,
        "interval": 20,
