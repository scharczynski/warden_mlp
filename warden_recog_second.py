...
# def run_script(cell_range):
    ...
    #     path_to_data, cell_range, window=[1000, 3000])
    # solver_params = {
    #     "niter": 10,
    #     "stepsize": 100,
    #     "interval": 10,
    ...
    # pipeline.set_model_x0("SigmaMuTauStim1", [10, 1600, 100, 1e-1, 1e-1])
    # pipeline.set_model_x0("SigmaMuTau", [10, 1600, 100, 1e-1, 1e-1])
...
def run_script(cell_range):
    # path_to_data = "/Users/stevecharczynski/workspace/data/warden/recog_trials/"
    # save_dir = "/Users/stevecharczynski/workspace/data/warden/recog_second/"
    save_dir = "/projectnb/ecog-eeg/stevechar/ml_runs/warden/recog_second/"
    path_to_data = "/projectnb/ecog-eeg/stevechar/data/warden/recog_second/"
    ...
    pipeline.set_model_bounds("Const", {"a_0":[10e-10, 1]})
    with open("/Users/stevecharczynski/workspace/data/warden/recog_second/info.json") as f:
    # with open("/projectnb/ecog-eeg/stevechar/data/warden/recog_trials/info.json") as f:
        stims = json.load(f)
        stims = {int(k):v for k,v in stims.items()}
    ...
    pipeline.set_model_x0("SigmaMuTauStimWarden", [10, 1600, 100, 1e-1, 1e-1,1e-1, 1e-1, 1e-1])
    pipeline.set_model_x0("SigmaMuTau", [10, 1600, 100, 1e-1, 1e-1])
    pipeline.set_model_x0("SigmaMuTauStim1", [10, 1600, 100, 1e-1, 1e-1])
    pipeline.set_model_x0("SigmaMuTauStim2", [10, 1600, 100, 1e-1, 1e-1])
    pipeline.set_model_x0("SigmaMuTauStim3", [10, 1600, 100, 1e-1, 1e-1])
    pipeline.set_model_x0("SigmaMuTauStim4", [10, 1600, 100, 1e-1, 1e-1])
    pipeline.set_model_x0("Const", [1e-1])
    pipeline.fit_all_models(solver_params=solver_params)
    pipeline.fit_even_odd(solver_params=solver_params)
    # pipeline.compare_even_odd("Const", "SigmaMuTau", 0.01)
