...
def run_script(cell_range):
    ...
    save_dir = "/projectnb/ecog-eeg/stevechar/ml_runs/warden/recall_trials_second_stim_time/"
    path_to_data = "/projectnb/ecog-eeg/stevechar/data/warden/recall_trials/"
    data_processor = analysis.DataProcessor(
        path_to_data, cell_range, window=[1250, 3000])
    solver_params = {
        "niter": 1500,
        "stepsize": 100,
        "interval": 20,
    ...
    pipeline.set_model_x0("GaussianStim1", [10, 1600, 1e-1, 1e-1])
    pipeline.set_model_x0("GaussianStim2", [10, 1600, 1e-1, 1e-1])
    pipeline.set_model_x0("GaussianStim3", [10, 1600, 1e-1, 1e-1])
    pipeline.set_model_x0("GaussianStim4", [10, 1600, 1e-1, 1e-1])
